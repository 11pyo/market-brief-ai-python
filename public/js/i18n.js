...
const LANGS = {
  ko: {
    ...
    shareNative: '브리핑 공유',
    // 언어 변경 재생성 팝업
    regenConfirmMsg: '언어를 한국어로 변경했습니다.\nAI 브리핑을 다시 생성할까요?',
    regenConfirmOk: '재생성',
    regenConfirmCancel: '취소',
    // 차트
  ...
  en: {
    ...
    regenConfirmMsg: 'Language changed to English.\nRegenerate the AI briefing?',
    regenConfirmOk: 'Regenerate',
  ...
  ja: {
    ...
    regenConfirmMsg: '言語を日本語に変更しました。\nAIブリーフィングを再生成しますか？',
    regenConfirmOk: '再生成',
    regenConfirmCancel: 'キャンセル',
